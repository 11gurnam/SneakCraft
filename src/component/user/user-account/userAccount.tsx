...
function ProfileIcon() {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <path d="M2.5 13.5c0-3 2.5-5 5.5-5s5.5 2 5.5 5" stroke="currentColor" strokeWidth="1.4"
                  strokeLinecap="round"/>
        </svg>
    );
}
...
function SupportIcon() {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <path d="M8 9V8c1-0.5 1.5-1.5 1-2.5S7.5 4 6.5 4.5" stroke="currentColor" strokeWidth="1.4"
                  strokeLinecap="round"/>
...
function TrashIcon() {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M3 5h10M6 5V3.5h4V5M5.5 5l.5 7.5h4L11 5" stroke="currentColor" strokeWidth="1.4"
...
export default function SneakCraftAccount() {
